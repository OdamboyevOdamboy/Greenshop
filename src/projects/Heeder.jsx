...
const Heeder=()=>{
  ...
  return(
  <>
    <div className="sticky top-0 w-full h-[5.2%] flex justify-between items-start">
      <div className="w-[22%] flex"><img src={flover} alt="" className='w-[clamp(18px,5.5vmin,34.3px)]'/><span className='text-[#46A358] font-bold text-[clamp(18px,2.901vmin,110.03px)]'>GREENSHOP</span></div>
      ...
      <div className="w-[22%] flex justify-around items-center">
      <img src={search} alt="" className='w-[clamp(18px,5.5vmin,20px)] h-[clamp(18px,5.5vmin,20px)]'/><img src={magazine} alt="" className='w-[clamp(18px,5.5vmin,24px)] h-[clamp(18px,5.5vmin,24px)]'/><button className='flex bg-green-600 rounded text-white p-dd'><LogOut className='w-6 h-6'/>Login</button>
      </div>
